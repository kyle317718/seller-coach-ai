...
import { ANALYSIS_STEP_LABELS } from '@/constants/analysisSteps';
...
const stepComponents: Record<string, React.FC<{ data?: any }>> = {
  market: MarketStep,
  pricing: PricingStep,
    ...
    <div className="max-w-2xl mx-auto py-8">
      ...
      <div className="bg-white/90 p-8 rounded-2xl shadow-xl border border-orange-100">
        <div className="flex items-center gap-3 mb-4">
          <span className="text-3xl">{ANALYSIS_STEP_LABELS[stepIdx] ?? stepKeys[stepIdx]}</span>
          <span className="font-bold text-xl text-gray-800">{stepIdx + 1}단계</span>
        </div>
        <div className="mb-6">
          <StepComponent data={result.data[stepKeys[stepIdx]]} />
        </div>
